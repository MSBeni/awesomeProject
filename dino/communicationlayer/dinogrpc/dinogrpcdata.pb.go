...
func (*Animal) Descriptor() ([]byte, []int) {
	return fileDescriptor_f9f657bfae3f0b4c, []int{0}
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_f9f657bfae3f0b4c, []int{1}
}
...
func init() {
	proto.RegisterFile("dinogrpcdata.proto", fileDescriptor_f9f657bfae3f0b4c)
}

var fileDescriptor_f9f657bfae3f0b4c = []byte{
...
func (*UnimplementedDinoServiceServer) GetAnimal(ctx context.Context, req *Request) (*Animal, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAnimal not implemented")
}
func (*UnimplementedDinoServiceServer) GetAllAnimals(req *Request, srv DinoService_GetAllAnimalsServer) error {
